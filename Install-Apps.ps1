...
#======================================================================
  ...
  winget install -h --id Microsoft.Office --accept-package-agreements --accept-source-agreements;winget install -h --id Mozilla.Firefox;winget install -h --id Google.Chrome;winget install -h --id Adobe.Acrobat.Reader.64-bit;winget install -h --id RingCentral.RingCentral;winget install -h --id Lenovo.SystemUpdate
